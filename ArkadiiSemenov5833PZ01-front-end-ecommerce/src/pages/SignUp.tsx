  ...
  return (
    <div className="flex w-full min-w-80 flex-col items-center justify-center gap-5">
      ...
      >
        ...
        <button
          type="submit"
          className="animate-pulse rounded-full border-2 border-accent-700 bg-accent-50 px-5 py-2 hover:animate-none disabled:animate-none disabled:border-gray-500 disabled:opacity-20"
        >
          Sign Up
        </button>

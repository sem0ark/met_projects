      ...
      <div className="relative w-96 overflow-hidden rounded-lg shadow-md">
        ...
        <div
          className={clsx(
            ...
            "absolute left-0 top-1/2 -translate-y-1/2 translate-x-1/2 transform",
          )}
        >
        ...
        {imageUrls.map((url, i) => (
          <div
            ...
            className={clsx(
              ...
              image === url
                ? "border-accent-400"
                : "border-white hover:border-accent-400",
            )}
            onClick={() => setIndex(i)}
          >
            <img
...
const ProductInfo = ({ product }: { product: Product }) => {
  ...
  return (
    <div className="flex w-full flex-1 flex-col gap-5">
      ...
      <p className="text-lg font-bold">{(product.price * 1.0).toFixed(2)} RSD</p>
      ...
      <Button
        className="mt-10 h-10 w-full rounded-full bg-accent-600 text-white active:bg-accent-200 sm:w-40"

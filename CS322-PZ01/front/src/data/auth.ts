...
import { LoginResponseSchema, CurrentUser, UserPost } from "./types";
...
export function useLogin() {
  ...
  return usePostSchema<UserPost, typeof LoginResponseSchema>([["user"]], `/users/auth/signin`, LoginResponseSchema, (data) => {
    login({
      token: data.token,
      ...data.user,
    });
